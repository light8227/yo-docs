...
* To edit the top screen's section find `title_u00_<LG>`, and for the bottom screen find `title_d00_<LG>`.
  ...
  * Click the save icon to save, and close the tab with the `.xi` file.
  * Now you should be in the tab containing the contents of the `.xa` file.
  * Click the save icon once again to save it.
  * Now, close the tab with the `.xa` file.
  * Finally, click `File -> Save As..` button to save your edited FA file.
